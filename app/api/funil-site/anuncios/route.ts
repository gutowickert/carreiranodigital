...
export async function GET(req: NextRequest) {
  try {
    ...
    const eventos = await carregar('site_eventos', 'visitor_id, evento, utm_campaign, utm_content, criado_em', deISO, ateISO, org)
    const clicks = await carregar('wa_clicks', 'utm_campaign, utm_content, lead_id, criado_em', deISO, ateISO, org)
    const leads = await carregar('leads', 'utm_campaign, utm_content, etapa, valor_venda, criado_em', deISO, ateISO, org)
