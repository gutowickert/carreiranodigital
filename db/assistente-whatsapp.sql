...
-- ─────────────────────────────────────────────── Nando (25/09, pedido do Guto)
UPDATE public.usuarios_perfil SET whatsapp = '5551995187713', apelido = 'Nando', assistente_bom_dia = true
 WHERE lower(email) = 'debairros@hotmail.com';
