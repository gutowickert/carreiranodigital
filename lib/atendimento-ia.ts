    ...
    try {
      const r2 = await client.messages.create({
        ...
        messages: [
          ...
          { role: 'user', content: 'PARE: sua "resposta" citou "R$100"/"sinal"/"entrada" — isso é TERMINANTEMENTE PROIBIDO, nunca é da nossa IA (é gancho de venda antiga). Reescreva SÓ o JSON, no MESMO formato, com a "resposta" pedindo pagamento correto: Pix à vista do valor cheio ou da bolsa, OU cartão em 6x sem juros. NUNCA mencione sinal, entrada, reserva por R$100 nem qualquer valor fora da tabela.' },
        ],
      })
